...
public class Produtos implements Serializable {
    ...
    private Collection<Itvendas> itvendasCollection;
    ...
    public Collection<Itvendas> getItvendasCollection() {
        return itvendasCollection;
    }

    public void setItvendasCollection(Collection<Itvendas> itvendasCollection) {
        this.itvendasCollection = itvendasCollection;
    }
    ...
    public String toString() {
        return "banco.novo.Produtos[ codpro=" + codpro + " ]";
    }
